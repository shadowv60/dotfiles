...
static const char *colorname[] = {
    ...
    "#ece6d9", /* 256: cursor */
    "#1e2224", /* 257: reverse cursor / selection bg */
    "#bbb49d", /* 258: foreground */
    "#1e2224", /* 259: background */
};
 ...
 */
const unsigned int mousescrollincrement = 5; /* Set to 3 or 5 for faster scrolling */
